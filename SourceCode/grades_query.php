...
$query2 = "SELECT grade, COUNT(grade) FROM Enrollment WHERE enrolled_section = $section and enrolled_course='$course' GROUP BY grade;";
...
if($result->num_rows > 0){
	...
	echo '<table align="center" border="0" cellspacing="2" cellpadding="2">
        <tr>
          ...
          <th> <font face="Arial">Number Of</font> </td>
        </tr>';
